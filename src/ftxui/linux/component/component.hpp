...
Component Menu(ConstStringListRef fileMenuEntries,
               int* selected_,
               Ref<MenuOption> = {});
Component MenuEntry(ConstStringRef label, Ref<MenuEntryOption> = {});
Component Dropdown(ConstStringListRef fileMenuEntries, int* selected);
Component Radiobox(ConstStringListRef fileMenuEntries,
                   int* selected_,
                   Ref<RadioboxOption> option = {});
Component Toggle(ConstStringListRef fileMenuEntries,
                 int* selected,
